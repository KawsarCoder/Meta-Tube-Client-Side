...
const ReviewDetails = () => {
  ...
  return (
    <div>
      {reviews.length > 0 ? (
        <>
          <div className="grid grid-cols-1 justify-items-center">
            <h2 className="text-center text-3xl font-bold mt-20 text-rose-500 border-b-4 border-blue-300 p-5 w-72">
              Your Review
            </h2>
          </div>
          <div className="grid grid-cols-12 mt-5 mb-20">
      ...
      {reviews.length === 0 ? (
        <>
          <div className="grid grid-cols-1 mb-20 justify-items-center">
