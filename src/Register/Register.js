...
const Register = () => {
  ...
  return (
    <div className="grid grid-cols-12">
      <form
        onSubmit={userSubmit}
        className="lg:col-start-4 lg:col-end-10 md:col-start-4 md:col-end-10 sm:col-start-2 sm:col-end-11 col-start-1 col-end-13 bg-blue-50 p-10 rounded-lg my-20"
      >
        <div className="relative z-0 mb-6 w-full group">
          <input
            ...
            name="email"
            id="email"
            className="block py-2.5 px-0 w-full text-lg font-semibold text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
            placeholder=""
            required=""
          />
          <label
        ...
        <div className="flex items-start my-6">
          ...
          <label
            htmlFor="remember"
            className="ml-2 text-lg font-sm font-medium text-gray-900 dark:text-gray-300"
          >
            Accept{" "}
        ...
        <span className="block mt-2 text-lg font-semibold text-red-700 rounded-lg dark:bg-red-200 dark:text-red-800">
          {error}
        </span>
        <button
          type="submit"
          id="submit"
          name="submit"
          className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 shadow-lg shadow-cyan-500/50 dark:shadow-lg dark:shadow-cyan-800/80 font-medium rounded-lg text-lg font-sm px-10 py-2.5 text-center mr-2 mb-2"
        >
          Submit
        </button>
      </form>
