      ...
      <div className="my-20 ">
        ...
        >
          ...
          <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 lg:w-[80%] w-full text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              Meta tube is a future famous youtube channel
            </h5>
            <p class="mb-3 lg:w-[80%] w-full font-normal text-gray-700 dark:text-gray-400">
